<?php
	...
	if ($db_found)
	{
		...
		if ($NbreResultatTrouvé == 0) 
		{
			...
			$RequeteIn = "INSERT INTO utilisateur (Pseudo,Nom,Prénom,Email,Password,Clause,Admin,Vendeur,Acheteur)
		...
		{
			//Redirection vers Page Inscription car le pseudo existe déjà
			echo "Erreur : $erreur";
			/*echo '
			<script language="JAVASCRIPT">
