...
<FONT size= "12pt"><center><strong><div class="panel-white">Placez vos enchères !</div></strong></center><br><br></FONT>
<div class="container">
    <div class="row">
       <?php
                if ($_SESSION['IDitem']=="") 
                  ...
                  <div class="col-sm-4">
                    <div class= "panel-footer"><br>
                      <div class="panel-body">
                        <img src="images/'.$data['urlPhoto'].'" class="img-responsive" style="width:300px; height:180px"; alt="Image">
                      </div>
                    </div>
                    <br>
                  </div>
                    ...
                    <div class="col-sm-7">
                        <div class= "panel-footer"><br>
                            <div class="panel-body"><strong>
                              '.$data['Nom'].'</strong><br>
                              Vendeur : '.$data['IDOwner'].'<br>
                              Prix : '.$data['Prix'].' €<br>
                              ID : '.$IDItem.'<br><br>
                              <form action="traitementenchere.php" method="post">
                                <label name="IDItem" value=".$IDItem.">
                                Montant de votre Enchère :</label>
                                <input type="number" name="PrixMax">
                                <br>
                                <input type="submit" value="Placer une Enchère">
                              <br>
                              </form>
                            </div><br>
                        </div>
