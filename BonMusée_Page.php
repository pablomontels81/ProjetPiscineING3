  ...
  <div class="row">
    <div class="col-sm-4">
      <div class= "panel-footer"><br>
        <div class="panel-body"><img src="images/style.jpg" class="img-responsive" style="width:300px; height:180px"; alt="Image"></div><br>
      </div>
        <br><div class="panel-white">Fauteuil style Mondrian</div>
...
<button type="button">Achat Direct</button><button type="button">Enchère</button><button type="button">Meilleure offre</button>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class= "panel-footer"><br>
        <div class="panel-body"><img src="images/o.png" class="img-responsive" style="width:300px; height:180px"; alt="Image"></div><br>
      </div>
        <br><div class="panel-white">Fauteuil style frères Campana</div>
        <strong><div class="panel-white">350€</div></strong>
<button type="button">Achat Direct</button><button type="button">Enchère</button><button type="button">Meilleure offre</button>
     <br><br>   
    </div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class= "panel-footer"><br>
        <div class="panel-body"><img src="images/chaise.jpg" class="img-responsive" style="width:300px; height:180px"; alt="Image"></div><br>
      </div>
        <br><div class="panel-white">Chaise longue Le Corbusier</div>
...
<div class="container">    
   <div class="row">
    <div class="col-sm-4">
      <div class= "panel-footer"><br>
        <div class="panel-body"><img src="images/bibli.jpg" class="img-responsive" style="width:300px; height:180px"; alt="Image"></div><br>
      </div>
        <br><div class="panel-white">Bibliotheque style Charlotte Perriand</div>
        <strong><div class="panel-white">670€</div></strong>
        <button type="button">Achat Direct</button><button type="button">Enchère</button><button type="button">Meilleure offre</button>
        <br><br>
    </div>
     <div class="row">
    <div class="col-sm-4">
      <div class= "panel-footer"><br>
        <div class="panel-body"><img src="images/prouve.jpg" class="img-responsive" style="width:300px; height:180px"; alt="Image"></div><br>
      </div>
        <br><div class="panel-white">Meuble design Jean Prouvé</div>
        <strong><div class="panel-white">730€</div></strong>
        <button type="button">Achat Direct</button><button type="button">Enchère</button><button type="button">Meilleure offre</button>
      <br><br> 
    </div>
    <div class="row">
    <div class="col-sm-4">
      <div class= "panel-footer"><br>
        <div class="panel-body"><img src="images/perriand.jpg" class="img-responsive" style="width:300px; height:180px"; alt="Image"></div><br>
      </div>
        <br><div class="panel-white">Fauteuil Charlotte Perriand</div>
        <strong><div class="panel-white">780€</div></strong>
        <button type="button">Achat Direct</button><button type="button">Enchère</button><button type="button">Meilleure offre</button>
        <br><br>
    </div>
</div><br><br>
