...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item">
        <img src="images/carrous1.png" alt="" style="width:703px;height:448px;">
        <div class="carousel-caption">
          <h3>Des accessoires de luxes</h3>
          <p>Nos plus belles pièces</p>
        </div>      
      ...
      <div class="item">
        <img src="images/carrous2.png" alt="Image"style="width:703px;height:448px;">
        <div class="carousel-caption">
          <h3>Des accessoires de luxes</h3>
          <p>Nos plus belles pièces</p>
        </div>      
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class= "panel-footer"><br>
        <div class="panel-body"><img src="images/fred.jpg" class="img-responsive" style="width:300px; height:180px"; alt="Image"></div><br>
      </div>
        <br><div class="panel-white">Bracelet Fred édition limitée</div>
        <strong><div class="panel-white">3 500€</div></strong>
...
<button type="button">Achat Direct</button><button type="button">Enchère</button><button type="button">Meilleure offre</button>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class= "panel-footer"><br>
        <div class="panel-body"><img src="images/voiture.jpg" class="img-responsive" style="width:300px; height:180px"; alt="Image"></div><br>
      </div>
        <br><div class="panel-white">Voiture de luxe Rolls-Royce</div>
        <strong><div class="panel-white">400 000€</div></strong>
<button type="button">Achat Direct</button><button type="button">Enchère</button><button type="button">Meilleure offre</button>
     <br><br>   
    </div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class= "panel-footer"><br>
        <div class="panel-body"><img src="images/lunette.jpg" class="img-responsive" style="width:300px; height:180px"; alt="Image"></div><br>
      </div>
        <br><div class="panel-white">Lunette de soleil en édition limitée Hermes</div>
        <strong><div class="panel-white">590€</div></strong>
        <button type="button">Achat Direct</button><button type="button">Enchère</button><button type="button">Meilleure offre</button>
        <br><br>  
<br><br>
    </div>
...
<div class="container">    
   <div class="row">
    <div class="col-sm-4">
      <div class= "panel-footer"><br>
        <div class="panel-body"><img src="images/collier.jpg" class="img-responsive" style="width:300px; height:180px"; alt="Image"></div><br>
      </div>
        <br><div class="panel-white">Collier Bulgari serpenti</div>
        <strong><div class="panel-white">6 500€</div></strong>
        <button type="button">Achat Direct</button><button type="button">Enchère</button><button type="button">Meilleure offre</button>
        <br><br>
    </div>
     <div class="row">
    <div class="col-sm-4">
      <div class= "panel-footer"><br>
        <div class="panel-body"><img src="images/roro.jpg" class="img-responsive" style="width:300px; height:180px"; alt="Image"></div><br>
      </div>
        <br><div class="panel-white">Montre Rolex</div>
        <strong><div class="panel-white">6 500€</div></strong>
        <button type="button">Achat Direct</button><button type="button">Enchère</button><button type="button">Meilleure offre</button>
      <br><br> 
    </div>
    ...
    <div class="col-sm-4">
      <div class= "panel-footer"><br>
        <div class="panel-body"><img src="images/chanel.jpg" class="img-responsive" style="width:300px; height:180px"; alt="Image"></div><br>
      </div>
        <br><div class="panel-white">Sac Timeless matelassé noir iconic</div>
        <strong><div class="panel-white">7 580€</div></strong>
        <button type="button">Achat Direct</button><button type="button">Enchère</button><button type="button">Meilleure offre</button>
        <br><br>
    </div>
</div><br><br>
