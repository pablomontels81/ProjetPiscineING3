...
<FONT size= "12pt"><center><strong><div class="panel-white">Récapitulatif de votre achat direct</div></strong></center><br><br></FONT>
<div class="container">
    <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class= "panel-footer"><br>
                            <div class="panel-body"><strong>
                              ...
                              Prix : '.$data['Prix'].' €<br>
                              ID : '.$IDItem.'<br><br><br>
                              <a href=traitementAchatDirect.php?IDItem='.$IDItem.'>
